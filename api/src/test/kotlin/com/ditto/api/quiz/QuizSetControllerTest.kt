                    ...
                    resource(
                        ResourceSnippetParameters.builder()
                            ...
                            .responseFields(
                                ...
                                fieldWithPath("data.quizSets[].weekStartedOn").description("운영 주 시작일 (해당 주 월요일, 주간 식별자)"),
                                fieldWithPath("data.quizSets[].year").description("년도 (weekStartedOn 파생 표시값, FE 전환 후 제거 예정)"),
                                fieldWithPath("data.quizSets[].month").description("월 (weekStartedOn 파생 표시값, FE 전환 후 제거 예정)"),
                                fieldWithPath("data.quizSets[].week").description("주차 (weekStartedOn 파생 표시값, FE 전환 후 제거 예정)"),
